...
public class ModPlacedFeatures {
    ...
    DeferredRegister.create(Registry.PLACED_FEATURE_REGISTRY, nymeriacraft.MODID);
...
public static final RegistryObject<PlacedFeature> ASCENDRIA_CHECKED = PLACED_FEATURES.register("ascendria_checked",
    () -> new PlacedFeature(ModConfiguredFeatures.ASCENDRIA.getHolder().get(),
            List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.ASCENDRIA_SAPLING.get()))));

public static final RegistryObject<PlacedFeature> ASCENDRIA_PLACED = PLACED_FEATURES.register("ascendria_placed",
    () -> new PlacedFeature(ModConfiguredFeatures.ASCENDRIA_SPAWN.getHolder().get(), VegetationPlacements.treePlacement(
...
public static final RegistryObject<PlacedFeature> DAYTIME_CHECKED = PLACED_FEATURES.register("daytime_checked",
                    () -> new PlacedFeature(ModConfiguredFeatures.DAYTIME.getHolder().get(),
                            List.of(PlacementUtils.filteredByBlockSurvival(ModBlocks.DAYTIME_SAPLING.get()))));
                
public static final RegistryObject<PlacedFeature> DAYTIME_PLACED = PLACED_FEATURES.register("daytime_placed",
                    () -> new PlacedFeature(ModConfiguredFeatures.DAYTIME_SPAWN.getHolder().get(), VegetationPlacements.treePlacement(
                            PlacementUtils.countExtra(3, 0.1f, 2))));

        public static final RegistryObject<PlacedFeature> MIDNIGHT_CHECKED = PLACED_FEATURES.register("midnight_checked",
        ...
        public static final RegistryObject<PlacedFeature> MIDNIGHT_PLACED = PLACED_FEATURES.register("midnight_placed",
                            () -> new PlacedFeature(ModConfiguredFeatures.MIDNIGHT_SPAWN.getHolder().get(), VegetationPlacements.treePlacement(
                                    PlacementUtils.countExtra(3, 0.1f, 2))));
