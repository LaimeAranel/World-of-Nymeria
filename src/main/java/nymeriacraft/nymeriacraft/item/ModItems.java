...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, nymeriacraft.MODID);
            ...
            () -> new SwordItem(Tiers.IRON, 2, 0, new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1)));
            ...
            public static final RegistryObject<Item> COBALTSWORD = ITEMS.register("cobalttools_sword",
                    () -> new SwordItem(Tiers.STONE, 2, 0, new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1)));
            ...
            public static final RegistryObject<Item> FARFEYSWORD = ITEMS.register("farfey_sword",
                    () -> new SwordItem(Tiers.DIAMOND, 2, 0, new Item.Properties().tab(CreativeModeTab.TAB_MISC).stacksTo(1)));
